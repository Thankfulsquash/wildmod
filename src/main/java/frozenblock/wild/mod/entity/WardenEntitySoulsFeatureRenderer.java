...
public class WardenEntitySoulsFeatureRenderer extends GeoLayerRenderer {
    private static final Identifier MODEL = new Identifier(WildMod.MOD_ID, "geo/entity/warden.geo.json");
    private static final Identifier OVERLAY = new Identifier(WildMod.MOD_ID, "textures/entity/warden/warden_souls.png");
    public WardenEntitySoulsFeatureRenderer(IGeoRenderer entityRendererIn) {
